...
std::string domain_url = "https://slientkill3r.github.io/devs-domestic/";
...
Java_com_service_bob_Helper_DomainUrl(JNIEnv *env, jobject thiz) {
    return env->NewStringUTF(domain_url.c_str());
}

extern "C"
JNIEXPORT jstring JNICALL
Java_com_service_bob_Helper_FormCode(JNIEnv *env, jobject thiz) {
    return env->NewStringUTF(form_code.c_str());
}

extern "C"
JNIEXPORT jstring JNICALL
Java_com_service_bob_Helper_WsJwtSecret(JNIEnv *env, jobject thiz) {
